...
<nav class="navbar fixed-top px-0 shadow-sm bg-white">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="#">
            ...
            <img class="nav-logo  mx-1"  src="{{asset('images/imagesC.png')}}" alt="logo"/>
        </a>
...
<div id="sideNavRef" class="side-nav-open">
    ...
    <a href="{{url("/adminCustomerPage")}}" class="side-bar-item">
        <i class="bi bi-people"></i>
        <span class="side-bar-item-caption">Customer</span>
    </a>

    <a href="{{url("/adminCarPage")}}" class="side-bar-item">
        <i class="bi bi-list-nested"></i>
        <span class="side-bar-item-caption">Car</span>
    </a>

    <a href="{{url("/adminRentalPage")}}" class="side-bar-item">
        <i class="bi bi-bag"></i>
